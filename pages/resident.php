...
-->                            <!-- /.nav-second-level -->
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i>Apply As Volunteer</a>
                           <!-- <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="membershipinfo.html"><i class="fa fa-info-circle fa-fw"></i>Membership Information</a>
                           <!-- <ul class="nav nav-second-level">
                                <li>
                                ...
                                <div class="col-lg-8">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="$HouseNo">
                                      ...
                                      <div class="form-group">
                                            <label>Village</label>
                                            <input  class="form-control" name="$Village" placeholder="Enter text">
                                        </div>
                                           <div class="form-group">
                                            <label>Country</label>
                                            <select class="form-control" name="country" id="country-list" onChange="getState(this.value);">
                                                ...
                                                <?php 
                                                $db=connect_db();
                                                $sql="select * from countrylist ORDERBY ASC";
                                                $exe = $db->query($sql);
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"  name="$PINcode" placeholder="Enter text">
                                        </div>
